...
--
-- Host: mysql:3306
-- Generation Time: May 14, 2020 at 09:58 PM
...
(1, 'Fernando Alonso', 'Oviedo, Asturias', '2020-03-19', 'alo.jpg', 'Piloto español de gran talento con 2 campeonatos en su mochila. Ha participado en otras disciplinas como son el Mundial de Resistencia, la IndyCar o el Dakar.'),
(2, 'Carlos Sainz Jr', 'Madrid, España', '2020-03-22', 'sai.jpg', 'Carlos Sainz Jr es una jóven promesa actualmente corriendo para McLaren'),
(3, 'Narain Karthikeyan', 'Coimbatore, India', '2020-03-20', 'kar.jpeg', 'Uno de los más celebres pilotos de la Fórmula 1. Su última aparición fue con la escuderia Force India.'),
(4, 'Lewis Hamilton', 'Stevenage, Reino Unido', '2020-03-20', 'ham.jpg', 'Piloto de gran talento que tiene actualmente 6 títulos mundiales. ¿Será capaz de igualar o superar a Michael Schumacher?'),
(5, 'Max Verstappen', 'Hasselt, Bélgica', '2020-03-20', 'ver.jpeg', 'Una de las jóvenes promesas de la Fórmula 1 actual que apunta alto desde que estaba en Toro Rosso. En su primera carrera de debut con Red Bull, la escudería padre de Toro Rosso, ganó su primer Gran Premio en el Circuit de Catalunya.'),
(6, 'Takuma Sato', 'Tokio, Japón', '2020-03-20', 'sat.jpg', 'Piloto japonés actualmente corriendo en IndyCar.'),
(7, 'Daniel Ricciardo', 'Perth, Australia', '2020-03-20', 'ric.jpg', 'Un piloto de gran valor en la parrilla actual de la F1 que por desgracia aún no ha conseguido grandes cosas en la competición.'),
(8, 'Pastor Maldonado', 'Maracay, Venezuela', '2020-03-20', 'mal.jpg', 'Quizás uno de los pilotos más infravalorados durante su paso por la competición.'),
(9, 'Jules Bianchi', 'Niza, Francia', '2020-03-20', 'bia.jpg', 'Un piloto que habría sido sin duda uno de los más grandes en la Fórmula 1.');
